...
import com.deckerpw.flateditor.lang.java.classreader.AccessFlags;
...
class ClassCompletion extends AbstractJavaSourceCompletion {
	...
	public Icon getIcon() {
		...
		else if (com.deckerpw.flateditor.lang.java.classreader.Util.isPublic(access)) {
			isPublic = true;
		}
		//else if (com.deckerpw.flateditor.lang.java.classreader.Util.isProtected(access)) {
		//	isProtected = true;
		//}
		//else if (com.deckerpw.flateditor.lang.java.classreader.Util.isPrivate(access)) {
		//	isPrivate = true;
		//}
		else {
			isDefault = true;
