 ...
 */
package com.deckerpw.flateditor.lang.java.classreader.attributes;
			...
			case 'L':
				...
				if (lt>-1 && lt<semicolon) { // Type parameters in type class
					...
					if (offs==str.length() || str.charAt(offs)!=';') {
						...
						//type = com.deckerpw.flateditor.lang.java.Util.replaceChar(type, '/', '.');
					...
					//clazz = com.deckerpw.flateditor.lang.java.Util.replaceChar(clazz, '/', '.');
