...
public final class IconFactory {
	...
	private IconFactory() {
		...
		iconMap.put(PACKAGE_ICON, loadIcon("package_obj.svg"));
		iconMap.put(IMPORT_ROOT_ICON, loadIcon("impc_obj.svg"));
		iconMap.put(IMPORT_ICON, loadIcon("imp_obj.svg"));
		...
		iconMap.put(CLASS_ICON, loadIcon("class_obj.svg"));
